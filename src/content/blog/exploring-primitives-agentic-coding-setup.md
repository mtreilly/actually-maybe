...
I learnt about a cool little tool for checking the Git status of multiple projects. I find myself leaning more and more on submodules, worktrees and multiple Git projects as a very simple baseline setup for exploratory agentic work.[^1]
...
[^1]: See [Hacker News discussion](https://news.ycombinator.com/item?id=45925109) and [myrepos](https://myrepos.branchable.com/related/).
